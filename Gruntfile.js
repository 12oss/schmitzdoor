module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/schmitzdoor.css',
				dest: '_gh_pages/dist/css/min/schmitzdoor.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/schmitzdoor.js',
				dest: '_gh_pages/dist/js/min/schmitzdoor.min.js'
			}
		},
		watch: {
			css: {
