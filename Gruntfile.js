	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: 'docs/dist/css/schmitzdoor.css'
			},
			js: {
				options: {
					separator: ';',
				...
				src: ['docs/assets/js/jquery.min.js',
					...
					'docs/assets/js/share-button.min.js'
				],

				dest: 'docs/dist/js/schmitzdoor.js'
			}
		},
		cssmin: {
			css: {
				src: 'docs/dist/css/schmitzdoor.css',
				dest: 'docs/dist/css/min/schmitzdoor.min.css'
			}
		},
		uglify: {
			js: {
				src: 'docs/dist/js/schmitzdoor.js',
				dest: 'docs/dist/js/min/schmitzdoor.min.js'
			}
		},
		watch: {
			css: {
